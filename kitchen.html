...
<body>
    ...
    <section class="px-4 sm:px-6 lg:px-12 py-10">
        <div class="flex flex-col lg:flex-row items-center lg:items-start space-y-6 lg:space-y-0 lg:space-x-8">
            <div class="flex-shrink-0">
                <img src="https://assets.telkitchens.co.uk/srcane/uploads/2021/04/20112147/Luxury-Modern-Kitchen-Designer.jpg" 
            ...
            <div class="lg:mt-0 lg:pl-6 text-center lg:text-left">
                <h1 class="font-bold font-serif text-3xl sm:text-4xl lg:text-5xl">Kitchen Decoration</h1>
                <p class="font-semibold text-xl sm:text-2xl lg:text-2xl pt-4 font-serif">GIVES YOUR COMFORT WITH REGAL TOUCH</p>
    ...
    <section class="px-4 sm:px-6 lg:px-12 py-10">
        <div class="mt-10">
            <h1 class="text-center font-bold text-orange-700 text-2xl sm:text-3xl">Kitchen Decoration</h1>
        </div>
        ...
        <div class="mt-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center border hover:shadow-lg transition-shadow">
                <img src="https://baczewskiluxury.com/wp-content/uploads/2023/01/olive-wooden-kitchen-cabinets-768x432.jpg" 
                     alt="Kitchen Furniture 1" 
            ...
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center border hover:shadow-lg transition-shadow">
                <img src="https://static.wixstatic.com/media/29ebc0_d5c8bc6222d640c3a4ab199c7da516bc~mv2.jpg/v1/fill/w_568,h_378,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/29ebc0_d5c8bc6222d640c3a4ab199c7da516bc~mv2.jpg" 
                     alt="Kitchen Furniture 2" 
                     class="h-[150px] sm:h-[200px] w-full object-cover rounded-md">
                     <div class="mt-2">
            ...
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center border hover:shadow-lg transition-shadow">
                <img src="https://images.woodenstreet.de/image/data/modular%20kitchen/Nexus.jpg" 
                     alt="Kitchen Furniture 3" 
                     class="h-[150px] sm:h-[200px] w-full object-cover rounded-md">
                     <div class="mt-2">
            ...
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center border hover:shadow-lg transition-shadow">
                <img src="https://www.makwanaworld.com/images/l-shaped-modular-kitchen-design-luxurious-modern-wooden-white-cabinets.webp" 
                     alt="Kitchen Furniture 4" 
                     class="h-[150px] sm:h-[200px] w-full object-cover rounded-md">
                     <div class="mt-2">
            ...
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center border hover:shadow-lg transition-shadow">
                <img src="https://www.makwanaworld.com/images/l-shaped-modular-kitchen-design-modern-sleek-functional-layout.webp" 
                     alt="Kitchen Furniture 5" 
                     class="h-[150px] sm:h-[200px] w-full object-cover rounded-md">
                     <div class="mt-2">
            ...
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center border hover:shadow-lg transition-shadow">
                <img src="https://i.pinimg.com/564x/b9/bb/2d/b9bb2ddf261cd4d045d62c043de05e88.jpg" 
                     alt="Kitchen Furniture 6" 
                     class="h-[150px] sm:h-[200px] w-full object-cover rounded-md">
                     <div class="mt-2">
            ...
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center border hover:shadow-lg transition-shadow">
                <img src="https://media.designcafe.com/wp-content/uploads/2023/01/02182321/trending-kitchen-cupboard-designs-with-crockery-bar-units.jpg" 
                     alt="Kitchen Furniture 7" 
                     class="h-[150px] sm:h-[200px] w-full object-cover rounded-md">
                     <div class="mt-2">
            ...
            <div class="bg-white p-4 sm:p-6 rounded-lg shadow-md text-center border hover:shadow-lg transition-shadow">
                <img src="https://ouchcart.com/cdn/shop/articles/00007.jpg?v=1687808567" 
                     alt="Kitchen Furniture 8" 
                     class="h-[150px] sm:h-[200px] w-full object-cover rounded-md">
                     <div class="mt-2">
